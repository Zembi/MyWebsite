...
class LeftMenu {
	...
	CreatePatronOfTheLeftMenu() {
		document.getElementById("leftBodyTCC").innerHTML = `
				<section id="leftBodyWrapC">
					<section id="leftBackgroundC">
					...
					<section id="downLeftC">
						<div id="downLeftWrapC">
							...
							<div id="downMainMenuC">
										...
										<div id="menuWrapShowC">
											<div id="menuCenterShowC">
												...
												<div id="aboutMeLeftMenuC" class="leftMenuBtnC">
													<button id="aboutMeLeftMenuBtn" class="leftMenuBtn">
														<div class="leftMenuTextC">About me</div>
														<img class="leftMenuImg">
													</button>
													<div id="subDirectoryAboutMeC" data-status="1">
														<ul>
															<li><a href="../AboutMe/education.html">Education</a></li>
															<li><a href="../AboutMe/skills.html">Skills</a></li>
														</ul>
													</div>
												</div>
								...
								<section id="menuProfileInfoC">
									<div id="menuProfileInfoCC">
										<div id="menuProfileInfoWrapPosC">
	...
	LeftScreenEventsHome() {
		...
		function OpenMenu(pointOfChange) {
			...
			if (GetPageWidth() > pointOfChange) {
				...
				menuProfileInfoC.style.justifyContent = "flex-end";
				menuProfileInfoCC.style.transformOrigin = "60% 100%";
			}
			else {
				//SMALL OPEN MENU
				...
				menuProfileInfoC.style.justifyContent = "center";
				menuProfileInfoCC.style.transformOrigin = "center";
			}

			//SOCIAL INFO
			menuProfileInfoCC.style.transform = "rotate(-90deg)";
		}
		...
		function CloseMenu(pointOfChange) {
			...
			var menuShowC = document.getElementById("menuShowC");
			var rightLineLeftMenuC = document.getElementById("rightLineLeftMenuC");
			var menuProfileInfoC = document.getElementById("menuProfileInfoC");
			var menuProfileInfoCC = document.getElementById("menuProfileInfoCC");
			var movingElementsBackgroundMenu = document.querySelector(".squaresUL").children;
			movingElementsBackgroundMenu = Array.from(movingElementsBackgroundMenu);
			...
			//SOCIAL INFO
			menuProfileInfoCC.style.transform = "rotate(0deg)";
		}
		...
		const aboutMeLeftMenuBtn = document.getElementById("aboutMeLeftMenuBtn");
		aboutMeLeftMenuBtn.addEventListener("click", function () {
			const subDirectoryAboutMeC = document.getElementById("subDirectoryAboutMeC");
			const check = parseInt(subDirectoryAboutMeC.dataset.status);
			if (check) {
				subDirectoryAboutMeC.style.maxHeight = "300px";

				subDirectoryAboutMeC.dataset.status = 0;
			}
			else {
				subDirectoryAboutMeC.style.maxHeight = "0";

				subDirectoryAboutMeC.dataset.status = 1;
			}
		});
	}
}