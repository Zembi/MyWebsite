	...
	class LeftMenu {
		...
		//MAIN FUNCTIONS
		Main() {
			this.CreatePatronOfTheSite();
			this.LeftScreenEventsHome();
		}

		CreatePatronOfTheSite() {
			document.getElementById('leftBodyTCC').innerHTML = '<div id="leftBackgroundC"><div class="backgroundMovingC"><ul class="squaresUL"><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div ></div><div id="leftBodyC"><div id="upLeftC"><div id="openMenuBtnC"><button id="openMenuBtn"><img id="menuImg"></button></div></div><div id="downLeftC"><div id="downMenuBtnLineC"><div id="downMenuBtnMovingInLineC"></div></div><div id="downMenuC"><div id="menuHideC"></div><div id="menuShowC"><div id="menuCenterShowC"><div id="homeLeftMenuC" class="leftMenuBtnC"><a class="leftMenuBtn"><div class="leftMenuTextC">Home</div><img class="leftMenuImg"></a></div><div id="resumeLeftMenuC" class="leftMenuBtnC"><a class="leftMenuBtn"><div class="leftMenuTextC">Resume</div><img class="leftMenuImg"></a></div><div id="aboutMeLeftMenuC" class="leftMenuBtnC"><a class="leftMenuBtn"><div class="leftMenuTextC">About me</div><img class="leftMenuImg"></a></div><div id="contactLeftMenuC" class="leftMenuBtnC"><a class="leftMenuBtn"><div class="leftMenuTextC">Contact</div><img class="leftMenuImg"></a></div></div><div id="rightLineLeftMenuC"></div></div></div><div id="menuProfileInfoC"><div id="menuProfileInfoCC"><div id="facebookProfC" class="menuProfC"><a id="facebookProfL" class="menuProfL" title="Facebook" href="https://ms-my.facebook.com/bvb.4ever1908/" target="_blank" rel="noreferrer noopener"><img id="facebookProfImg" class="menuProfImg"></a></div><div id="instagramProfC" class="menuProfC"><a id="instagramProfL" class="menuProfL" title="Instagram" href="https://www.instagram.com/zembi_b/" target="_blank" rel="noreferrer noopener"><img id="instagramProfImg" class="menuProfImg"></a></div><div id="linkedInProfC" class="menuProfC"><a id="linkedInProfL" class="menuProfL" title="LinkedIn" href="https://www.linkedin.com/in/vasileios-filippos-zembilas-a08908189" target="_blank" rel="noreferrer noopener"><img id="linkedInProfImg" class="menuProfImg"></a></div><div id="githubProfC" class="menuProfC"><a id="githubProfL" class="menuProfL" title="GitHub" href="https://github.com/Zembi" target="_blank" rel="noreferrer noopener"><img id="githubProfImg" class="menuProfImg"></a></div></div></div></div>';
		}
